...
const TermsPolicy = () => {
  return (
    <section className="terms-policy relative">
  ...
  Please read these terms and conditions carefully before using Our Service.</p>
              <h3 className="text-2xl mt-10 mb-5">Interpretation and Definitions</h3>
              <h4 className="text-xl mt-10 mb-5">Interpretation</h4>
              <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
              <h4 className="text-xl mt-10 mb-5">Definitions</h4>
  ...
  <h3 className="text-2xl mt-10 mb-5">Acknowledgment</h3>
  ...
  <h3 className="text-2xl mt-10 mb-5">Links to Other Websites</h3>
  ...
  <h3 className="text-2xl mt-10 mb-5">Termination</h3>
  ...
  <h3 className="text-2xl mt-10 mb-5">Limitation of Liability</h3>
  ...
  <h3 className="text-2xl mt-10 mb-5">"AS IS" and "AS AVAILABLE" Disclaimer</h3>
  ...
  <h3 className="text-2xl mt-10 mb-5">Governing Law</h3>
  <p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.</p>
  <h3 className="text-2xl mt-10 mb-5">Disputes Resolution</h3>
  <p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>
  <h3 className="text-2xl mt-10 mb-5">For European Union (EU) Users</h3>
  <p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.</p>
  <h3 className="text-2xl mt-10 mb-5">United States Legal Compliance</h3>
  <p>You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>
  <h3 className="text-2xl mt-10 mb-5">Severability and Waiver</h3>
  <h4 className="text-xl mt-10 mb-5">Severability</h4>
  <p>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>
  <h4 className="text-xl mt-10 mb-5">Waiver</h4>
  <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under this Terms shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall be the waiver of a breach constitute a waiver of any subsequent breach.</p>
  <h3 className="text-2xl mt-10 mb-5">Translation Interpretation</h3>
  <p>These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.</p>
  <h3 className="text-2xl mt-10 mb-5">Changes to These Terms and Conditions</h3>
  ...
  <h3 className="text-2xl mt-10 mb-5">Contact Us</h3>
